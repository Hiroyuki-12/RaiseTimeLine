 ...
 *
 * <p>MyBatis を使っているため JPA のアノテーションは不要。 mybatis.configuration.map-underscore-to-camel-case=true
 * の設定により、 DB のスネークケース列名（例: password_hash）が Java のキャメルケース（passwordHash）に自動マッピングされる。
 */
public class User {
